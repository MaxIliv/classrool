...
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"src/assets/css/main.scss":[function(require,module,exports) {
var reloadCSS = require('_css_loader');
...
var FormControl = /*#__PURE__*/function () {
  ...
  _createClass(FormControl, [{
    ...
    value: function handleSubmit(e) {
      ...
      this.data.email = elements.email.value;
      this.data.firstName = elements.firstName.value;
      this.data.lastName = elements.lastName.value;
      this.data.info = elements.info.value;
    }
  }, {
    key: "lockForm",
    value: function lockForm() {
      this.form.classList.add('form--disabled');
      this.form.querySelector('button').classList.add('btn--disabled');
    }
  }, {
    key: "unlockForm",
    value: function unlockForm() {
      this.form.classList.remove('form--disabled');
      this.form.querySelector('button').classList.remove('btn--disabled');
    }
  }]);
...
var _default = {};
exports.default = _default;
},{"normalize.css":"node_modules/normalize.css/normalize.css","~src/assets/css/main.scss":"src/assets/css/main.scss","./form":"src/js/form.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
